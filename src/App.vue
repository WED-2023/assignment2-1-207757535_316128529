      ...
      <b-navbar toggleable="lg" type="dark" variant="dark" class="bg-green">
        ...
        <b-collapse id="nav-collapse" is-nav>
          <b-navbar-nav class="mx-auto">
            ...
            <b-nav-form>
              <b-form-input ref="searchInput" size="sm" v-model="searchQuery" class="mr-sm-2" placeholder="Search"></b-form-input>
              <b-nav-item :to="{ name: 'search', query: { q: searchQuery } }" size="sm" @click="handleSearch"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
